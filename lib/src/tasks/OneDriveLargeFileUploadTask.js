...
var OneDriveLargeFileUploadTask = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        requestUrl = OneDriveLargeFileUploadTask.constructCreateSessionUrl(options.groupID, options.fileName, options.path);
     ...
     */
    OneDriveLargeFileUploadTask.constructCreateSessionUrl = function (groupID, fileName, path) {
